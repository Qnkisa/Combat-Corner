...
<div class="product-container">
    ...
    <div class="product-container-content">
        <h1>Dominator fake leather black</h1>
        ...
        <div class="product-reviews-helper">
            <div class="review">
                ...
                <div class="review-text">
                    <p>"I recently purchased the Dominator fake leather black boxing gloves and they have quickly become my favorite pair for training and competition. The synthetic leather mimics the feel and durability of real leather, but at a more affordable price point."</p>
                </div>
            </div>
            <div class="review">
                <div class="review-maker">
                    <img src="images/r-p-24.jpg" alt="">
                    <p>Zed Russell</p>
                    <div class="product-rating-stars">
                        <ion-icon name="star-outline" class="star-icon"></ion-icon>
                        <ion-icon name="star-outline" class="star-icon"></ion-icon>
                ...
                <div class="review-text">
                    <p>"I have been using the Dominator fake leather black boxing gloves for several months now and they have exceeded my expectations. The reinforced stitching is extremely durable and the multi-layer foam padding provides excellent protection for my hands. I also appreciate the sleek black design, it gives me a professional look while I'm training and competing."</p>
                </div>
            </div>
        </div>
    </div>
