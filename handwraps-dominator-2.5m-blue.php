...
<div class="product-container">
    ...
    <div class="product-container-content">
        ...
        <div class="product-description">
            <p>The Dominator 2.5m Blue Handwraps are an excellent choice for martial artists looking for high-quality, durable hand wraps that provide superior protection and support. These handwraps are made from a blend of cotton and elastic, which provides a perfect balance of flexibility and support for the wrists and hands.</p>
        ...
        <div class="product-reviews-helper">
            <div class="review">
                ...
                <div class="review-text">
                    <p>"I've been using the Dominator 2.5m Blue Handwraps for my kickboxing training, they have been great! The hook and loop closure keeps them securely in place and the thumb loop ensures a perfect fit. I highly recommend them!"</p>
                </div>
            </div>
            <div class="review">
                <div class="review-maker">
                    <img src="images/r-p-94.jpg" alt="">
                    <p>Wallis Homewood</p>
                    <div class="product-rating-stars">
                        <ion-icon name="star-outline" class="star-icon"></ion-icon>
                        <ion-icon name="star-outline" class="star-icon"></ion-icon>
                ...
                <div class="review-text">
                    <p>"I have been using the Dominator 2.5m Blue Handwraps for my Muay Thai training, they are amazing! They provide great support for my wrists and hands, and the elastic blend allows for a good range of motion. I would highly recommend these handwraps to any martial artist."</p>
                </div>
            </div>
        </div>
    </div>
