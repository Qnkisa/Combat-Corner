...
<div class="product-container">
    ...
    <div class="product-container-content">
        <h1>weight vest armageddon 20kg</h1>
        ...
        <div class="product-reviews-helper">
            <div class="review">
                <div class="review-maker">
                    <img src="images/r-p-127.jpg" alt="">
                    <p>Collins Arterberry</p>
                    <div class="product-rating-stars">
                        <ion-icon name="star-outline" class="star-icon"></ion-icon>
                        <ion-icon name="star-outline" class="star-icon"></ion-icon>
                        <ion-icon name="star-outline" class="star-icon"></ion-icon>
                ...
                <div class="review-text">
                    <p>"I've been using the Armageddon Weight Vest for a few months now and I am extremely impressed with its quality and versatility. The 20kg weight is perfect for intermediate and advanced users looking to take their training to the next level. The vest is comfortable to wear and easy to use, making it a great tool for a wide range of exercises and activities. I highly recommend this weight vest to anyone looking to add resistance to their workouts."</p>
                </div>
            </div>
            <div class="review">
                <div class="review-maker">
                    <img src="images/r-p-128.jpg" alt="">
                    <p>Trevelyan Monk</p>
                    <div class="product-rating-stars">
                        <ion-icon name="star-outline" class="star-icon"></ion-icon>
                        <ion-icon name="star-outline" class="star-icon"></ion-icon>
                ...
                <div class="review-text">
                    <p>"The Armageddon Weight Vest is a game changer for me. It's durable, comfortable, and versatile, making it perfect for a wide range of exercises and activities. The 20kg weight is perfect for intermediate and advanced users and it's suitable for indoor and outdoor use. I highly recommend this weight vest to anyone looking to take their fitness to the next level."</p>
                </div>
            </div>
        </div>
    </div>
