...
<div class="product-container">
    ...
    <div class="product-container-content">
        <h1>weight vest armageddon 10kg</h1>
    ...
    <div class="similar-products">
        ...
        <div class="similar-products-helper">
            <div class="similar-product">
                ...
                <p>weight vest armageddon 15kg</p>
                <span>50$</span>
        ...
        <div class="product-reviews-helper">
            <div class="review">
                <div class="review-maker">
                    <img src="images/r-p-123.jpg" alt="">
                    <p>Braden Moore</p>
                    <div class="product-rating-stars">
                        <ion-icon name="star-outline" class="star-icon"></ion-icon>
                        <ion-icon name="star-outline" class="star-icon"></ion-icon>
                ...
                <div class="review-text">
                    <p>"I've been using the Armageddon Weight Vest for a few months now and I am extremely impressed with its quality and versatility. The 10kg weight is perfect for intermediate and advanced users looking to take their training to the next level. The vest is comfortable to wear and easy to use, making it a great tool for a wide range of exercises and activities. I highly recommend this weight vest to anyone looking to add resistance to their workouts."</p>
                </div>
            </div>
            <div class="review">
                <div class="review-maker">
                    <img src="images/r-p-124.jpg" alt="">
                    <p>Stewart Maynard</p>
                    <div class="product-rating-stars">
                        <ion-icon name="star-outline" class="star-icon"></ion-icon>
                        <ion-icon name="star-outline" class="star-icon"></ion-icon>
                ...
                <div class="review-text">
                    <p>"The Armageddon Weight Vest is a game changer for me. It's durable, comfortable, and versatile, making it perfect for a wide range of exercises and activities. The 10kg weight is perfect for intermediate and advanced users and it's suitable for indoor and outdoor use. I highly recommend this weight vest to anyone looking to take their fitness to the next level."</p>
                </div>
            </div>
        </div>
    </div>
