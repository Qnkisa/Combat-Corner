...
<div class="product-container">
    ...
    <div class="product-container-content">
        <h1>Venum Contender 2.0 gold</h1>
        ...
        <div class="product-reviews-helper">
            <div class="review">
                ...
                <div class="review-text">
                    <p>"I've been using the Venum Contender 2.0 gold gloves for about 6 months now and I couldn't be happier with my purchase. These gloves are extremely well-made and the synthetic leather feels very durable. The padding is also excellent and I've never had any issues with my hands or wrists during training."</p>
                </div>
            </div>
            <div class="review">
                <div class="review-maker">
                    <img src="images/r-p-44.jpg" alt="">
                    <p>Darell Chamberlain</p>
                    <div class="product-rating-stars">
                        <ion-icon name="star-outline" class="star-icon"></ion-icon>
                        <ion-icon name="star-outline" class="star-icon"></ion-icon>
                        <ion-icon name="star-outline" class="star-icon"></ion-icon>
                ...
                <div class="review-text">
                    <p>"I recently purchased the Venum Contender 2.0 gold gloves and have been very impressed with them so far. The gloves are extremely comfortable and the padding provides a lot of protection. I've used them for both sparring and heavy bag work, and they have held up well."</p>
                </div>
            </div>
        </div>
    </div>
